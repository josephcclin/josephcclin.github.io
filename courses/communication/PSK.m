...
%--------------------------------------------------------------------------------------------    
    ...
    clear sum;
	figure( 'NumberTitle' , 'off' , 'name', 'Phase-Shift Keying (PSK)' , 'position', [12 49 1000 670]);  %產生一個 figure，設定 title 及 [left bottom width heigh] 
...
%--------------------------------------------------------------------------------------------    
    ...
    threshold = sqrt(E)-0.003;
    
    cosfun1 = sqrt((2*E)/T) * cos(2*pi*f*t); %make a cosin function for modulation
